...
export function IssueCard() {
  return (
    // The picker rises out of the composer, so the scene is tall enough to
    // hold it: drawn above the scene's box it landed on the card's text
    // wherever the text wrapped far enough to meet it.
    <div className={`flex h-full flex-col justify-end px-2 pb-2 ${s.scene}`}>
